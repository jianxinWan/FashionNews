    ...
    <div class="form-warp">
      <el-form :model="ruleForm2" status-icon :rules="rules2" ref="ruleForm2" class="demo-ruleForm">
        <el-form-item prop="email">
          <el-input placeholder="请输入你的邮箱账号" v-model="ruleForm2.email"></el-input>
        </el-form-item>
        <el-form-item prop="code">
          <el-input placeholder="验证码" v-model="ruleForm2.code">
            <span slot="suffix" @click="getEmailCode">获取验证码</span>
          </el-input>
        </el-form-item>
        ...
        <el-form-item>
          <el-button type="primary" @click="submitForm('ruleForm2')">注册账号</el-button>
        </el-form-item>
      </el-form>
      <div class="cut-warp">
        <p>
...
export default {
  ...
  methods: {
    ...
    signUp: function() {
      let signUpUrl =
        "http://118.89.221.170:8080/news/user/register/" + this.ruleForm2.code;
      axios({
        method: "post",
        url: signUpUrl,
        data: {
